 ...
 */
public class CsvUpLoadDialog extends Dialog {
    public CsvUpLoadDialog(Context context) {
        super(context);
    }
    ...
    public static class Builder {
        ...
        public CsvUpLoadDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CsvUpLoadDialog dialog = new CsvUpLoadDialog(context);
