...
import com.wenruisong.basestationmap.navi.util.TTSController;
...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle = getIntent().getBundleExtra(Constants.NAVI_BUNDLE);
         if(bundle.getDouble(Constants.START_LAT,0)!=0){
             mStartLatlng = new NaviLatLng(bundle.getDouble(Constants.START_LAT,0),bundle.getDouble(Constants.START_LNG,0));
         }
        if(bundle.getDouble(Constants.END_LAT,0)!=0){
            mEndLatlng = new NaviLatLng(bundle.getDouble(Constants.END_LAT,0),bundle.getDouble(Constants.END_LNG,0));
        }
